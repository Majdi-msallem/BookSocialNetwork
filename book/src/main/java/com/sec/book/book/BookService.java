package com.sec.book.book;


import com.sec.book.common.PageResponse;
import com.sec.book.exception.OperationNotPermittedException;
import com.sec.book.feedback.FileStorageService;
import com.sec.book.history.BookTransactionHistory;
import com.sec.book.history.BookTransactionHistoryRepository;
import com.sec.book.user.User;
...
import static com.sec.book.book.BookSpecification.withOwnerId;
...
public class BookService {
    ...
    public Integer save(BookRequest request, Authentication connectedUser) {
        ...
        if (book.getCreatedBy() == null) {
            book.setCreatedBy(user.getId());  // Assuming 'getId()' gives you the user identifier
        }
        book.setOwner(user);
